...
def get_parent_id():
    """ Safely fetches the dynamic _PARENT_ID from the main gdrive plugin if set """
    try:
        import sys
...
class _GDriveProxy:
    """ Stripped down GDrive class focused only on isolated proxy uploads """
    ...
    def _service(self) -> object:
        """ Builds a Google API service strictly isolated to the defined proxy """
